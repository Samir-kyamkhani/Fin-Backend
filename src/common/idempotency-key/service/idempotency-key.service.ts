...
export class IdempotencyKeyService {
  create(createIdempotencyKeyDto: CreateIdempotencyKeyDto) {
    return 'This action adds a new idempotencyKey';
  }

  findAll() {
    return `This action returns all idempotencyKey`;
  }
  ...
  update(id: number, updateIdempotencyKeyDto: UpdateIdempotencyKeyDto) {
